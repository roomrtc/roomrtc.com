...
export class CategoryService {
  ...
  getItemsGroup() {
    return this
      .httpClient
      .get(`${this.API_URL}/item/group`);
  }
  // Request create category api
  saveItem(newCategory) {
    return this
      .httpClient
      .post(`${this.API_URL}/item`, newCategory);
  }
  getDataSelect() {
    return this.httpClient.get < any > (`${this.API_URL}/item/child`);
  }
  // updateItem(newCategory){   return
  // this.httpClient.put(`${this.API_URL}/category`,newCategory) }
  // deleteItem(idCategory){   return
  // this.httpClient.delete(`${this.API_URL}/category`,newCategory) }
