...
export class ReportEditComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.route.params.subscribe((params) => {
      ...
      this.reportServices.getItem(currentReport.id).subscribe((data) => {
        ...
        const danh_sach_nhom_hang_muc = _.groupBy(data.items, 'idItemParent');
  ...
  handleDeleteHangMucControl(value, idGroup) {
    ...
    const select_hang_mucControll = this.reportForm.controls['select_hang_muc'].value;
    ...
    // Find hang muc cha
    const temp = this.DanhSachSelected.find((element: any) => {
