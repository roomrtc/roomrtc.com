(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["components-report-report-module"],{
...
/***/ "./src/app/components/report/report-edit/report-edit.component.css":
/*!*************************************************************************!*\
  !*** ./src/app/components/report/report-edit/report-edit.component.css ***!
  \*************************************************************************/
/*! no static exports found */
...
/***/ "./src/app/components/report/report-edit/report-edit.component.html":
/*!**************************************************************************!*\
  !*** ./src/app/components/report/report-edit/report-edit.component.html ***!
  \**************************************************************************/
/*! no static exports found */
...
/* harmony import */ var _models_list_category_model__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../../models/list_category.model */ "./src/app/models/list_category.model.ts");
...
/* harmony import */ var _models_catergory_model__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../../models/catergory.model */ "./src/app/models/catergory.model.ts");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm5/router.js");
/* harmony import */ var _models_report_model__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../../models/report.model */ "./src/app/models/report.model.ts");
...
var ReportEditComponent = /** @class */ (function () {
    function ReportEditComponent(fb, reportServices, categoryServices, route, router) {
        var _this = this;
        this.fb = fb;
        ...
        this.selectedAccounts5Fn = function (item, selected) {
        ...
        this.createForm();
        this.categoryServices.getDataSelect().subscribe(function (data) {
            _this.DuLieuSelect = data;
        });
    }
    ReportEditComponent.prototype.ngOnInit = function () {
        ...
        this.route.params.subscribe(function (params) {
            var currentReport = new _models_report_model__WEBPACK_IMPORTED_MODULE_8__["Report"]();
            currentReport.id = params.id;
            _this.reportForm.addControl('id', new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormControl"](params.id));
            _this.reportServices.getItem(currentReport.id).subscribe(function (data) {
                if (lodash__WEBPACK_IMPORTED_MODULE_5__["toInteger"](data.status)) {
                    return _this.router.navigate(['dashboard/report-list']);
                }
                _this.reportForm.controls['tieu_de_bao_cao'].setValue(data.tieu_de_bao_cao);
                _this.reportForm.controls['ten_nguoi_bao_cao'].setValue(data.ten_nguoi_bao_cao);
                _this.reportForm.controls['ghi_chu'].setValue(data.ghi_chu);
                _this.reportForm.controls['ngay_bao_cao'].setValue(data.ngay_bao_cao);
                _this.reportForm.controls['is_template'].setValue(data.is_template);
                // Xử lý thông tin hạng mục báo cáo
                var dataSourceSelected = data.items.map(function (item) {
                    return {
                        id: item.idItem,
                ...
                _this.reportForm.controls['select_hang_muc'].setValue(dataSourceSelected);
                //Lay thong tin hang muc them vao hang muc cua report created
                var danh_sach_nhom_hang_muc = lodash__WEBPACK_IMPORTED_MODULE_5__["groupBy"](data.items, 'idItemParent');
                lodash__WEBPACK_IMPORTED_MODULE_5__["each"](danh_sach_nhom_hang_muc, function (element, i) {
                    var newListCategory = new _models_list_category_model__WEBPACK_IMPORTED_MODULE_3__["ListCategory"]();
                    newListCategory.id = element[0].idItemParent;
                    newListCategory.ten_hang_muc = element[0].itemParent.ten_hang_muc;
                    element.forEach(function (child) {
                        var newCategory = new _models_catergory_model__WEBPACK_IMPORTED_MODULE_6__["Category"]();
                    ...
                    _this.DanhSachSelected.push(newListCategory);
                });
            });
        });
    };
    ReportEditComponent.prototype.groupByFn = function (item) {
        return item.parent.ten_hang_muc;
    };
    ReportEditComponent.prototype.handleAdd = function (event) {
        //Chon hang muc con
        if (event.id) {
            ...
            var check = lodash__WEBPACK_IMPORTED_MODULE_5__["findIndex"](this.DanhSachSelected, function (o) {
            ...
            var temp_1 = this.DuLieuSelect.filter(function (element) {
            ...
            var check = lodash__WEBPACK_IMPORTED_MODULE_5__["findIndex"](this.DanhSachSelected, function (o) {
                return o.id == temp_1[0].idItemParent;
            });
            if (check >= 0) {
                //Co hang listCategory roi
                this.DanhSachSelected[check].danh_sach_hang_muc = temp_1;
            }
            else {
                //Chua co listCategory
                var newListCategory = new _models_list_category_model__WEBPACK_IMPORTED_MODULE_3__["ListCategory"]();
                newListCategory.id = temp_1[0].idItemParent;
                newListCategory.ten_hang_muc = event.ten_hang_muc;
                newListCategory.danh_sach_hang_muc = temp_1;
                this.DanhSachSelected.push(newListCategory);
            }
        }
    };
    //Xu ly khi clear select
    ReportEditComponent.prototype.handleClear = function () {
        this.DanhSachSelected = [];
    };
    //Xu ly khi nguoi dung remove tung tag
    ReportEditComponent.prototype.handleRemove = function (event) {
        console.log(event);
        ...
        if (value.id) {
            ...
            console.log(event);
            var tmp = this.reportForm.controls['select_hang_muc'].value;
            lodash__WEBPACK_IMPORTED_MODULE_5__["remove"](this.DanhSachSelected, function (current) {
                return current.ten_hang_muc == value.ten_hang_muc;
            });
        }
    };
    //Sự kiện khi người dùng xoa các tag con
    ReportEditComponent.prototype.deleteChild = function (hangMuc) {
        console.log(hangMuc);
        //Find hang muc cha
        var temp = this.DanhSachSelected.find(function (element) {
            return element.ten_hang_muc == hangMuc.parent.ten_hang_muc;
        });
        console.log(temp);
        lodash__WEBPACK_IMPORTED_MODULE_5__["remove"](temp.danh_sach_hang_muc, function (current) {
    ...
    ReportEditComponent.prototype.handleDeleteHangMucControl = function (value, idGroup) {
        ...
        var select_hang_mucControll = this.reportForm.controls['select_hang_muc'].value;
        //Xoa hang muc selected
        lodash__WEBPACK_IMPORTED_MODULE_5__["remove"](select_hang_mucControll, function (current) {
    ...
    ReportEditComponent.prototype.createForm = function () {
        this.reportForm = this.fb.group({
            tieu_de_bao_cao: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].required],
            ten_nguoi_bao_cao: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].required],
            ghi_chu: [''],
            select_hang_muc: [],
            ngay_bao_cao: [],
            is_template: []
    ...
    ReportEditComponent.prototype.onSubmit = function () {
        var _this = this;
        console.log('submit');
        var prepearModel = this.reportForm.value;
        this.reportForm.reset();
        this.isLoading = true;
        prepearModel.select_hang_muc = this.DanhSachSelected;
        this.reportServices.updateReport(prepearModel).subscribe(function (response) {
            setTimeout(function () {
                _this.isLoading = false;
                // this.DanhSachSelected=[]
                _this.router.navigate(['dashboard/report-list']);
            }, 2000);
        });
    };
    ReportEditComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            template: __webpack_require__(/*! ./report-edit.component.html */ "./src/app/components/report/report-edit/report-edit.component.html"),
            styles: [__webpack_require__(/*! ./report-edit.component.css */ "./src/app/components/report/report-edit/report-edit.component.css")]
        }),
...
/***/ "./src/app/components/report/report-list/report-list.component.css":
/*!*************************************************************************!*\
  !*** ./src/app/components/report/report-list/report-list.component.css ***!
  \*************************************************************************/
/*! no static exports found */
...
var ReportListComponent = /** @class */ (function () {
    function ReportListComponent(reportServices) {
        this.reportServices = reportServices;
        //Config search pipe
        this.keySearch = '';
        this.keySearchDraft = '';
    ...
    ReportListComponent.prototype.ngOnInit = function () {
        ...
        this.reportServices.getAll(1).subscribe(function (data) {
            _this.danh_sach_bao_cao = data;
        });
        //Lay danh sach bao cao da trinh chieu
        this.reportServices.getReport(1, 1).subscribe(function (data) {
            _this.reportDone = data;
        });
        this.reportServices.getReport(1, 0).subscribe(function (data) {
            _this.reportDraft = data;
        });
        //Lay danh sach bao cao dang trien
    };
    ReportListComponent.prototype.onPreview = function (report, type) {
        console.log('Presenting: ', type, report.id);
        var newUrl = "http://localhost:3000/api/report/" + report.id + "/present/" + type;
        document.getElementById('presenter').setAttribute('src', newUrl);
        document.getElementById("myNav").style.width = "100%";
    };
    ReportListComponent.prototype.closeNav = function () {
        swal({
    ...
    ReportListComponent.prototype.onEdit = function (report) {
    };
    ReportListComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'app-report-list',
            template: __webpack_require__(/*! ./report-list.component.html */ "./src/app/components/report/report-list/report-list.component.html"),
            styles: [__webpack_require__(/*! ./report-list.component.css */ "./src/app/components/report/report-list/report-list.component.css")]
        }),
...
/***/ "./src/app/components/report/report-new/report-new.component.css":
/*!***********************************************************************!*\
  !*** ./src/app/components/report/report-new/report-new.component.css ***!
  \***********************************************************************/
/*! no static exports found */
...
/***/ "./src/app/components/report/report-new/report-new.component.html":
/*!************************************************************************!*\
  !*** ./src/app/components/report/report-new/report-new.component.html ***!
  \************************************************************************/
/*! no static exports found */
...
/***/ "./src/app/components/report/report-new/report-new.component.ts":
/*!**********************************************************************!*\
  !*** ./src/app/components/report/report-new/report-new.component.ts ***!
  \**********************************************************************/
/*! exports provided: ReportNewComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ReportNewComponent", function() { return ReportNewComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/forms */ "./node_modules/@angular/forms/fesm5/forms.js");
/* harmony import */ var _services_report_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../services/report.service */ "./src/app/services/report.service.ts");
/* harmony import */ var _models_list_category_model__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../../models/list_category.model */ "./src/app/models/list_category.model.ts");
...
var ReportNewComponent = /** @class */ (function () {
    function ReportNewComponent(fb, reportServices, categoryServices) {
        var _this = this;
        this.fb = fb;
        this.reportServices = reportServices;
        this.categoryServices = categoryServices;
    ...
    ReportNewComponent.prototype.groupByFn = function (item) {
        if (!item.parent)
            return 'ROOT';
        return item.parent.ten_hang_muc;
    };
    ReportNewComponent.prototype.handleAdd = function (event) {
        //Chon hang muc con
        if (event.id) {
            //Neu la lan dau tien thi tao ca nhom
            var newCategory = new _models_catergory_model__WEBPACK_IMPORTED_MODULE_6__["Category"]();
            ...
            var check = lodash__WEBPACK_IMPORTED_MODULE_5__["findIndex"](this.DanhSachSelected, function (o) { return o.id == event.parent.id; });
            if (check >= 0) {
                //Co hang listCategory roi
                this.DanhSachSelected[check].danh_sach_hang_muc.push(newCategory);
            }
            ...
            //B2: Kiem tra listCategory da co chua
            var check = lodash__WEBPACK_IMPORTED_MODULE_5__["findIndex"](this.DanhSachSelected, function (o) { return o.id == temp_1[0].idItemParent; });
            if (check >= 0) {
                //Co hang listCategory roi
                this.DanhSachSelected[check].danh_sach_hang_muc = temp_1;
            }
    ...
    //Xu ly khi clear select
    ReportNewComponent.prototype.handleClear = function () {
        this.DanhSachSelected = [];
    };
    //Xu ly khi nguoi dung remove tung tag
    ReportNewComponent.prototype.handleRemove = function (event) {
        console.log(event);
        //Truong hop remove hang muc con
        var value = event.value;
        if (value.id) {
    ...
    //Sự kiện khi người dùng xoa các tag con
    ReportNewComponent.prototype.deleteChild = function (hangMuc) {
        console.log(hangMuc);
        //Find hang muc cha
        var temp = this.DanhSachSelected.find(function (element) {
            return element.ten_hang_muc == hangMuc.parent.ten_hang_muc;
    ...
    //Xu li su kien nguoi dung click vao dau x de xoa hang muc
    ReportNewComponent.prototype.handleDeleteHangMucControl = function (value, idGroup) {
        // this.selectedHangMuc=[{ id: 19, ten_hang_muc: "Tổng số khám", group: { id: 2, ten_hang_muc: "Thống kê bệnh nhân" } }]
        //Lay danh sach selected trong controll
        var select_hang_mucControll = this.reportForm.controls['select_hang_muc'].value;
        //Xoa hang muc selected
    ...
    ReportNewComponent.prototype.createForm = function () {
        this.reportForm = this.fb.group({
            tieu_de_bao_cao: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].required],
            ten_nguoi_bao_cao: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].required],
            ghi_chu: [''],
    ...
    ReportNewComponent.prototype.onSubmit = function () {
        var _this = this;
        console.log('submit');
        var prepearModel = this.reportForm.value;
        this.reportForm.reset();
        this.isLoading = true;
        prepearModel.select_hang_muc = this.DanhSachSelected;
        this.reportServices.saveItem(prepearModel).subscribe(function (response) {
            setTimeout(function () {
                _this.isLoading = false;
                _this.DanhSachSelected = [];
            }, 2000);
        });
    };
    ReportNewComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            template: __webpack_require__(/*! ./report-new.component.html */ "./src/app/components/report/report-new/report-new.component.html"),
            styles: [__webpack_require__(/*! ./report-new.component.css */ "./src/app/components/report/report-new/report-new.component.css")]
        }),
        __metadata("design:paramtypes", [_angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormBuilder"], _services_report_service__WEBPACK_IMPORTED_MODULE_2__["ReportService"], _services_category_service__WEBPACK_IMPORTED_MODULE_4__["CategoryService"]])
    ], ReportNewComponent);
...
/* harmony import */ var _report_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./report.component */ "./src/app/components/report/report.component.ts");
/* harmony import */ var _report_list_report_list_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./report-list/report-list.component */ "./src/app/components/report/report-list/report-list.component.ts");
/* harmony import */ var _report_new_report_new_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./report-new/report-new.component */ "./src/app/components/report/report-new/report-new.component.ts");
/* harmony import */ var _report_edit_report_edit_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./report-edit/report-edit.component */ "./src/app/components/report/report-edit/report-edit.component.ts");
/* harmony import */ var _report_routing__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./report.routing */ "./src/app/components/report/report.routing.ts");
...
/* harmony import */ var _pipe_search_search_pipe__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../../pipe/search/search.pipe */ "./src/app/pipe/search/search.pipe.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    ReportModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            imports: [
                ...
                _angular_router__WEBPACK_IMPORTED_MODULE_2__["RouterModule"].forChild(_report_routing__WEBPACK_IMPORTED_MODULE_7__["ReportRoutes"])
            ],
            declarations: [_report_component__WEBPACK_IMPORTED_MODULE_3__["ReportComponent"], _report_list_report_list_component__WEBPACK_IMPORTED_MODULE_4__["ReportListComponent"], _report_new_report_new_component__WEBPACK_IMPORTED_MODULE_5__["ReportNewComponent"], _report_edit_report_edit_component__WEBPACK_IMPORTED_MODULE_6__["ReportEditComponent"], _pipe_search_search_pipe__WEBPACK_IMPORTED_MODULE_12__["SearchPipe"]]
        })
    ], ReportModule);
    return ReportModule;
}());
...
/***/ "./src/app/components/report/report.routing.ts":
/*!*****************************************************!*\
  !*** ./src/app/components/report/report.routing.ts ***!
  \*****************************************************/
...
/* harmony import */ var _report_list_report_list_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./report-list/report-list.component */ "./src/app/components/report/report-list/report-list.component.ts");
/* harmony import */ var _report_new_report_new_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./report-new/report-new.component */ "./src/app/components/report/report-new/report-new.component.ts");
/* harmony import */ var _report_edit_report_edit_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./report-edit/report-edit.component */ "./src/app/components/report/report-edit/report-edit.component.ts");
/* harmony import */ var _report_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./report.component */ "./src/app/components/report/report.component.ts");
...
var ReportRoutes = [
    {
        ...
        children: [
            ...
            {
                path: 'report-list',
                component: _report_list_report_list_component__WEBPACK_IMPORTED_MODULE_0__["ReportListComponent"],
                data: {
            ...
            {
                path: 'report-new',
                component: _report_new_report_new_component__WEBPACK_IMPORTED_MODULE_1__["ReportNewComponent"],
                data: {
            ...
            {
                path: 'report-edit/:id',
                component: _report_edit_report_edit_component__WEBPACK_IMPORTED_MODULE_2__["ReportEditComponent"],
                data: {
...
/***/ "./src/app/pipe/search/search.pipe.ts":
/*!********************************************!*\
  !*** ./src/app/pipe/search/search.pipe.ts ***!
  \********************************************/
...
var ReportService = /** @class */ (function () {
    ...
    ReportService.prototype.getAll = function (idKhoa) {
        return this.httpClient.get(this.API_URL + "/report?idKhoa=" + idKhoa);
    };
    ReportService.prototype.getReportById = function (id) {
        return this.httpClient.get(this.API_URL + "/report/" + id);
    };
    //Lay danh dach category theo ma khoa
    ReportService.prototype.getKhoaHasCategory = function () {
        return this.httpClient.get(this.API_URL + "/khoa-has-category/1");
    };
    // Request create category api
    ReportService.prototype.saveItem = function (newReport) {
        return this.httpClient.post(this.API_URL + "/report", newReport);
    };
    //Cap nhat bao cao
    ReportService.prototype.updateReport = function (report) {
        return this.httpClient.put(this.API_URL + "/report/" + report.id, report);
    };
    //Cap nhat trang thai bao cao
    ReportService.prototype.updateStatus = function (idBaoCao) {
        return this.httpClient.put(this.API_URL + "/report/" + idBaoCao + "/status", { idBaoCao: idBaoCao });
    };
    //Lay thong tin bao cao
    ReportService.prototype.getItem = function (idReport) {
        return this.httpClient.get(this.API_URL + "/report/" + idReport);
    };
    //Lay danh dach category theo ma giao ban
    ReportService.prototype.getReportHasCategory = function (idReport) {
        return this.httpClient.get(this.API_URL + "/giaoban-has-category/" + idReport);
    };
    //Lay danh sach hang muc by id bao cao
    ReportService.prototype.getDanhSachHangMucByIdReport = function (idReport) {
        return this.httpClient.get(this.API_URL + "/report/get-list-hang-muc/" + idReport);
    };
    ReportService.prototype.getDanhSachHangMucPresent = function (idReport) {
        return this.httpClient.get(this.API_URL + "/report/get-list-hang-muc-present/" + idReport);
    };
    //Lay danh sach bao cao da trinh chieu
    ReportService.prototype.getReport = function (idKhoa, status) {
        return this.httpClient.get(this.API_URL + "/report?idKhoa=" + idKhoa + "&status=" + status);
    };
...
//# sourceMappingURL=components-report-report-module.js.map